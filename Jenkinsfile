pipeline {
  ...
  environment {
    ...
    GITWEBADD = 'https://github.com/JaejinLee1215/sb_code.git'
    GITSSHADD = 'git@github.com:JaejinLee1215/sb_code.git'
    GITDEPADD = 'git@github.com:JaejinLee1215/deployment.git'
